...
//==============================================================================
EnvelopePanel::EnvelopePanel(CapstoneSynthAudioProcessor& p) : processor(p)
{
	...
	attackSlider.setDoubleClickReturnValue(true, 0.1f);
	...
	decaySlider.setDoubleClickReturnValue(true, 5.0f);
	...
	sustainSlider.setDoubleClickReturnValue(true, 0.5f);
	...
	releaseSlider.setDoubleClickReturnValue(true, 0.1f);
	...
	sliderTreeAttack = std::make_unique< AudioProcessorValueTreeState::SliderAttachment>(processor.tree, "attack", attackSlider);
	sliderTreeDecay = std::make_unique< AudioProcessorValueTreeState::SliderAttachment>(processor.tree, "decay", decaySlider);
	sliderTreeSustain = std::make_unique< AudioProcessorValueTreeState::SliderAttachment>(processor.tree, "sustain", sustainSlider);
	sliderTreeRelease = std::make_unique< AudioProcessorValueTreeState::SliderAttachment>(processor.tree, "release", releaseSlider);
}
